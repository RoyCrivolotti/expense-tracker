...
/** The batch side reuses the single form's own field labels (both say
 * "Amount (€)"), so scope to it explicitly rather than risk an ambiguous match. */
function batchForm(container: HTMLElement) {
  return within(container.querySelector('[data-testid="grouped-transaction-form"]')!)
}
