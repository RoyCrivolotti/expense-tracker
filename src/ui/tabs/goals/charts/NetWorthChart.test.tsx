...
describe('NetWorthChart', () => {
  ...
  it('gives the hero chart a tooltip on a phone, where its legend is below the fold', () => {
    ...
    onPhone(true)
    const phone = render(<NetWorthChart {...heroProps} />)
    expect(screen.queryByRole('tooltip')).not.toBeInTheDocument()
    fireEvent.keyDown(phone.container.querySelector('svg[role="img"]')!, { key: 'Home' })
